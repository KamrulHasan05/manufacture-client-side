...
const Footer = () => {
    return (
        <footer className='footer-bg pt-5 pb-3'>
                ...
                <div className="row">
                    ...
                    <div className="col-md-4 col-sm-6 col-8">
                        <ul>
                            ...
                            <li>Contact: <a href={'mailto:khrony903@gmail.com'}>khrony903@gmail.com</a></li>
                        </ul>
                    </div>
            ...
            <div>
                <p className='text-center m-0 pt-2 text-secondary'> &copy; All Right reserved from || Gigabyte {new Date().getUTCFullYear()}</p>
            </div>
        </footer>
    );
};
